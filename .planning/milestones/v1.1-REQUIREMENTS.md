# Requirements Archive: v1.1 Personal AI Running Coach
...
> **Note:** IMP-01/02/03 were explicitly descoped before Phase 4 by user decision — not needed. Checkboxes reflect traceability bookkeeping only, not implementation.

- [x] ~~**IMP-01**: User can paste raw LLM conversation text containing a training plan~~ *(descoped)*
- [x] ~~**IMP-02**: Claude extracts and normalizes the plan into the standard session schema~~ *(descoped)*
- [x] ~~**IMP-03**: User sees a preview of the parsed plan before it is saved (to catch unit errors or ambiguities)~~ *(descoped)*
...
| IMP-01 | Phase 4 | Descoped (user decision) |
| IMP-02 | Phase 4 | Descoped (user decision) |
| IMP-03 | Phase 4 | Descoped (user decision) |
