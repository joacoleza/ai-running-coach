...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 14-01-01 | 01 | 1 | GYM-01, DISC-03 | unit | `cd api && npm test -- runs.test.ts` | ✅ extend existing | ⬜ pending |
| 14-01-02 | 01 | 1 | GYM-01, DISC-03 | unit | `cd web && npm test -- RunEntryForm.test.tsx` | ✅ extend existing | ⬜ pending |
| 14-01-03 | 01 | 1 | GYM-02 | unit | `cd api && npm test -- runs.test.ts` | ✅ extend existing | ⬜ pending |
| 14-02-01 | 02 | 1 | DISC-04 | unit | `cd web && npm test -- RunBadge.test.tsx` | ✅ Wave 1 new file | ⬜ pending |
| 14-02-02 | 02 | 1 | DISC-05 | unit | `cd web && npm test -- Runs.test.tsx` | ✅ extend existing | ⬜ pending |
| 14-03-01 | 03 | 2 | GYM-02 | unit | `cd web && npm test -- ExerciseForm.test.tsx` | ✅ Wave 2 new file | ⬜ pending |
| 14-03-02 | 03 | 2 | GYM-02 | unit | `cd web && npm test -- RunDetailModal.test.tsx` | ✅ extend existing | ⬜ pending |
| 14-04-01 | 04 | 2 | GYM-03, GYM-04 | unit | `cd web && npm test -- ExerciseChecklistItem.test.tsx` | ✅ Wave 2 new file | ⬜ pending |
| 14-04-02 | 04 | 2 | GYM-04 | unit | `cd api && npm test -- planDays.test.ts` | ✅ extend existing | ⬜ pending |
| 14-05-01 | 05 | 3 | GYM-06 | unit | `cd api && npm test -- chat.test.ts` | ✅ extend existing | ⬜ pending |
| 14-05-02 | 05 | 3 | GYM-05 | unit | `cd api && npm test -- prompts.test.ts` | ✅ extend existing | ⬜ pending |
...
- [ ] `web/src/components/runs/RunBadge.tsx` — Discipline badge component (created by Plan 02)
- [ ] `web/src/__tests__/RunBadge.test.tsx` — Unit tests for discipline badge (created by Plan 02)
...
- [ ] Wave 1 prerequisites cover all MISSING references in Wave 2 plans
- [ ] No watch-mode flags
